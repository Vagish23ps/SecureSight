...
import { AlertTriangle, ArrowLeft, Calendar, GitBranch, Shield, FileText } from 'lucide-react';
...
export default function FindingDetailsPage() {
  ...
  const [finding, setFinding] = useState<SecurityFindings | null>(null);
          ...
          <>
            ...
            <div className="mb-12">
              <div className="flex items-start justify-between mb-6">
                ...
                <div className={`${getSeverityBgColor(finding.severity)} px-6 py-3`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              ...
              <div className="border border-deepbrown/20 p-8">
                <h2 className="font-heading text-2xl text-foreground mb-6">Vulnerability Details</h2>
              ...
              {/* Remediation Info */}
              <div className="border border-deepbrown/20 p-8">
                <h2 className="font-heading text-2xl text-foreground mb-6">Remediation Information</h2>
                <div className="space-y-4">
                  <div className="flex items-center justify-between py-3 border-b border-deepbrown/20">
                    <span className="font-paragraph text-base text-secondary-foreground">Status</span>
                    <span className={`font-paragraph text-base font-semibold ${getRemediationColor(finding.remediationStatus)}`}>
                      {finding.remediationStatus}
                    </span>
                  </div>
                  <div className="flex items-center justify-between py-3 border-b border-deepbrown/20">
                    <span className="font-paragraph text-base text-secondary-foreground">Repository</span>
                    <span className="font-paragraph text-base text-secondary-foreground">{finding.repositoryName}</span>
                  </div>
                  <div className="flex items-center justify-between py-3">
                    <span className="font-paragraph text-base text-secondary-foreground">Title</span>
                    <span className="font-paragraph text-base text-secondary-foreground">{finding.title}</span>
                  </div>
                </div>
              </div>
            </div>
